...
import { Sparkles, Building, Star, Shield, Plus, Briefcase } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description: "Additional cleaning services to complement your main cleaning package, such as laundry, window washing, or special requests.",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbGVhbmluZyUyMHN1cHBsaWVzfGVufDB8fHx8MTc2NzM1NjMwMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
  },
  {
    icon: Briefcase,
    title: "Janitorial Services",
    description: "Comprehensive janitorial services for large facilities, including floor care, waste management, and maintenance.",
    image: "https://images.unsplash.com/photo-1584464491033-06628f3a6b7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxqYW5pdG9yaWFsJTIwc2VydmljZXN8ZW58MHx8fHwxNzY3MzU2MzAxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
  }
];
